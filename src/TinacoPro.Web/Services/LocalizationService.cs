    ...
    private void InitializeTranslations()
    {
        _translations = new Dictionary<string, Dictionary<string, string>>
        {
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["NewTemplate"] = "New Template",
                ["EditTemplate"] = "Edit Template",
                ["NoTemplatesFound"] = "No templates yet. Create your first template!",
                ["CostSummary"] = "Cost Summary",
                ["EstTime"] = "Est. Time",
                ["TotalCost"] = "Total Cost",
                ["NoPartsFound"] = "No parts yet. Add parts to build your template!",
                ["SelectTemplatePrompt"] = "Select a template from the list to view details",
                ["Assembly"] = "Assembly",
                ["Material"] = "Material",
                ["Component"] = "Component",
                ["Process"] = "Process",
                ["LowStock"] = "Low Stock",
                ["QuickAddMaterial"] = "Quick Add Material",
                ["AddChildPart"] = "Add Child Part",
                ...
                ["NoCustomersFound"] = "No customers found. Create your first customer!",
                ...
                ["Manager"] = "Manager",
                ["State"] = "State",
                ["NoSitesFound"] = "No sites found. Create your first site!",
            ...
            ["es"] = new Dictionary<string, string>
            {
                ...
                ["LowStockAlert"] = "Alerta de Stock Bajo",
                // TemplateBuilder page
                ["ProductTemplateBuilder"] = "Constructor de Plantillas de Producto",
                ["Templates"] = "Plantillas",
                ["NewTemplate"] = "Nueva Plantilla",
                ["EditTemplate"] = "Editar Plantilla",
                ["NoTemplatesFound"] = "¡Aún no hay plantillas. Cree su primera plantilla!",
                ["CostSummary"] = "Resumen de Costos",
                ["EstTime"] = "Tiempo Est.",
                ["TotalCost"] = "Costo Total",
                ["NoPartsFound"] = "¡Aún no hay partes. Agregue partes para construir su plantilla!",
                ["SelectTemplatePrompt"] = "Seleccione una plantilla de la lista para ver detalles",
                ["Assembly"] = "Ensamblaje",
                ["Material"] = "Material",
                ["Component"] = "Componente",
                ["Process"] = "Proceso",
                ["LowStock"] = "Stock Bajo",
                ["QuickAddMaterial"] = "Agregar Material Rápido",
                ["AddChildPart"] = "Agregar Parte Hija",
                ...
                ["PartDeleted"] = "Parte eliminada exitosamente",
                ...
                ["NoCustomersFound"] = "¡No se encontraron clientes. Cree su primer cliente!",
                ...
                ["Manager"] = "Gerente",
                ["State"] = "Estado",
                ["NoSitesFound"] = "¡No se encontraron sitios. Cree su primer sitio!",
                ["SiteCreated"] = "Sitio creado exitosamente",
